...
if len(passengers_tracking_dataframe) > 0:
    ...
    bar_chart(
        total_grouped_trackings_dataframe,
        y=["total_command_trackings", "total_event_trackings", "total_query_trackings"],
    )
