...
trackings_prefetch_filters = TrackingsPrefetchFilters("query")
trackings_prefetch_filters.build()

trackings_service = TrackingsDataService(FetchQueryTrackingsQueryBuilder(), trackings_prefetch_filters)
